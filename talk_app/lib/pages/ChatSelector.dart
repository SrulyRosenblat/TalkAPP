        ...
        itemBuilder: (context, index) {
          ...
          return Container(
              decoration: BoxDecoration(
                ...
                borderRadius:
                    BorderRadius.circular(8), // Rounded rectangle corners
              ),
              margin: const EdgeInsets.symmetric(vertical: 6, horizontal: 16),
              child: ListTile(
                title: Text(chat['title'] ?? 'No title',
                    style: const TextStyle(
                        color: Colors.white,
                        fontSize: 24)), // Providing a fallback value for null
                subtitle: Text(chat['subtitle'] ?? 'No subtitle',
                    style: const TextStyle(
                        color: Colors
                            .white)), // Providing a fallback value for null
                onTap: () {
                  if (chat['chatId'] != null) {
                    // Checking for null before navigating
